    ...
    <section id="work" className="min-h-screen bg-[#f6f1e8] px-5 pb-24 pt-32 text-[#101820] sm:px-8 lg:pb-32">
      <div className="mx-auto max-w-7xl">
        ...
        <div className="mt-12 grid gap-6 lg:grid-cols-[0.8fr_1.2fr]">
            ...
            {projects.map((project, index) => (
              ...
              >
                <div className="flex items-center justify-between gap-4">
                  <p className="text-xs font-black uppercase tracking-[0.2em]" style={{ color: active === index ? project.color : '#ff6b4a' }}>
                    {project.label}
                  </p>
          ...
          <article className="animate-reveal rounded-[2rem] border border-[#101820]/10 bg-white p-6 shadow-2xl shadow-[#101820]/8">
              ...
              <div>
                ...
                <div className="mt-4 flex flex-wrap gap-2">
                  {selected.stack.map((item) => (
                    <span key={item} className="rounded-full border border-[#101820]/10 px-3 py-2 text-xs font-black uppercase tracking-[0.12em] text-[#101820]/62">
                      {item}
                    </span>
                  ))}
                </div>
                <a href="#contact" className="mt-8 inline-flex items-center gap-3 text-sm font-black uppercase tracking-[0.16em] text-[#101820]">
