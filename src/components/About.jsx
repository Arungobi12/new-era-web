    ...
    <section id="profile" className="min-h-screen bg-[#f6f1e8] px-5 pb-24 pt-32 text-[#101820] sm:px-8 lg:pb-32">
      <div className="mx-auto max-w-7xl">
        <div className="grid gap-12 lg:grid-cols-[0.9fr_1.1fr] lg:items-end">
          ...
          <p className="max-w-2xl text-xl leading-9 text-[#101820]/68">
        ...
        <div className="mt-14 grid gap-4 lg:grid-cols-3">
          {proof.map(([number, title, text]) => (
            <article key={title} className="group rounded-[1.75rem] border border-[#101820]/10 bg-white p-6 transition hover:-translate-y-1 hover:border-[#ff6b4a]/50">
