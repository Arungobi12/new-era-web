  ...
  return (
    <section id="contact" className="relative min-h-screen overflow-hidden bg-[#101820] px-5 pb-24 pt-32 text-[#f6f1e8] sm:px-8 lg:pb-32">
      ...
      <div className="relative mx-auto max-w-7xl">
        <div className="grid gap-10 lg:grid-cols-[1fr_0.9fr] lg:items-center">
          <div>
            ...
            <div className="mt-10 flex flex-wrap gap-3">
              <a href="mailto:arungobi12@gmail.com" className="rounded-full bg-[#f6f1e8] px-5 py-3 text-sm font-black text-[#101820] transition hover:bg-[#ff6b4a]">
                <FaEnvelope className="mr-2 inline" /> Email
              </a>
              <a href="https://github.com/arungobi12" target="_blank" rel="noreferrer" className="rounded-full border border-[#f6f1e8]/15 px-5 py-3 text-sm font-black transition hover:border-[#00b2a9] hover:text-[#00b2a9]">
                <FaGithub className="mr-2 inline" /> GitHub
              </a>
              <a href="https://www.linkedin.com" target="_blank" rel="noreferrer" className="rounded-full border border-[#f6f1e8]/15 px-5 py-3 text-sm font-black transition hover:border-[#c4d600] hover:text-[#c4d600]">
          ...
          <div className="rounded-[2rem] border border-[#f6f1e8]/10 bg-[#f6f1e8] p-5 text-[#101820]">
            <div className="grid gap-3">
              <input
                ...
                className="h-14 rounded-2xl border border-[#101820]/10 bg-white px-4 text-sm font-bold outline-none transition focus:border-[#ff6b4a]"
              ...
              <textarea
                ...
                className="min-h-36 resize-none rounded-2xl border border-[#101820]/10 bg-white p-4 text-sm font-bold outline-none transition focus:border-[#ff6b4a]"
                placeholder="Tell me what you want to build"
              />
              <a href={mailHref} className="inline-flex h-14 items-center justify-center rounded-2xl bg-[#101820] text-sm font-black uppercase tracking-[0.16em] text-[#f6f1e8] transition hover:bg-[#ff6b4a] hover:text-[#101820]">
                Compose message
              </a>
            </div>
          </div>
        ...
        <footer className="mt-16 flex flex-col justify-between gap-4 border-t border-[#f6f1e8]/10 pt-8 text-sm font-bold text-[#f6f1e8]/55 sm:flex-row">
